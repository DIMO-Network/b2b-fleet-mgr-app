  ...
  render() {
    return html`
      <div class="page active" id="page-users">
        ...
        <div class="section-header mt-24" style="display: flex; justify-content: space-between; align-items: center;">
              ...
              : html`
                  ...
                  <div class="pagination mt-16">
                    <button
                      ...
                      @click=${() => this.handleAdminPageChange(Math.max(0, this.adminSkip - this.adminTake))}
                    >
                      PREV
                    </button>
                    <span style="margin: 0 8px; font-size: 14px;">
                      Showing ${this.adminSkip + 1} - ${Math.min(this.adminSkip + this.adminTake, this.adminTotalCount)} of ${this.adminTotalCount}
                    </span>
                    <button
                      class="pagination-btn"
                      ?disabled=${this.adminSkip + this.adminTake >= this.adminTotalCount}
                      @click=${() => this.handleAdminPageChange(this.adminSkip + this.adminTake)}
                    >
                      NEXT
                    </button>
                  </div>
