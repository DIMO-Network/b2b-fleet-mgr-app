            ...
            <div class="app-container">
                ...
                <aside class="sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <div class="nav-item active" data-page="home" @click=${() => this.navigate('/home')}>Home</div>
                        <div class="nav-item" data-page="vehicles" @click=${() => this.navigate('/vehicles-fleets')}>Vehicles & Fleets</div>
                        <div class="nav-item" data-page="users" @click=${() => this.navigate('/users')}>Users</div>
                        <div class="nav-item hidden" data-page="vehicle-detail" id="nav-vehicle-detail">Vehicle Detail</div>
                        <div class="nav-divider"></div>
                        <div class="nav-item" data-page="reports" @click=${() => this.navigate('/reports')}>Reports</div>
                        <div class="nav-item" data-page="onboarding" @click=${() => this.navigate('/onboarding')}>Onboarding</div>
                    </nav>
                </aside>
